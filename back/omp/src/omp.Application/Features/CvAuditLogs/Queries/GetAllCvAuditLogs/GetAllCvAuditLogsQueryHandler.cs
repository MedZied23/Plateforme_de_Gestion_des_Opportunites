...
{
    public class GetAllCvAuditLogsQueryHandler : IRequestHandler<GetAllCvAuditLogsQuery, PaginatedList<CvAuditLogDto>>
    {
        private readonly IApplicationDbContext _context;

        public GetAllCvAuditLogsQueryHandler(IApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<PaginatedList<CvAuditLogDto>> Handle(GetAllCvAuditLogsQuery request, CancellationToken cancellationToken)
        {
