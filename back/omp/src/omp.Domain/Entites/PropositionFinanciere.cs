...
{
    public class PropositionFinanciere
    {
        public Guid Id { get; set; }
        public string? Nom { get; set; }        public DateTime? DateCreation { get; set; }
        public DateTime? DateModification { get; set; }
        public Guid? CreatedBy { get; set; }
        public int? nbrSemaines { get; set; }
        public List<List<int>>? MatricePL { get; set; } = new(); // HJ
        public List<List<int>>? MatricePLSiege { get; set; } = new(); // HJ
        public List<List<int>>? MatricePLTerrain { get; set; } = new(); // HJ
        ...
        public Dictionary<Guid, decimal>? PourcentBudgetPartenaires { get; set; } = new();
        public int? TotalExpenses { get; set; }        public int? TotalProjet { get; set; }
        public decimal? NbrJoursParMois { get; set; }        public Dictionary<TypeDepense, int>? prixDepenses { get; set; } = new();
